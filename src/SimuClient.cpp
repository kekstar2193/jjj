...
SIMUCLIENT_API bool bInitialisiereGrafik(int sizeX, int sizeY, const char* address, const char* port) {
   ...
   string programName = "java -jar /Users/kekillialiresid/eclipse-workspace/Aufgabenblock_2/src/SimuServer.jar " + Port;   std::thread worker (executeProgram, programName);
   worker.detach();
